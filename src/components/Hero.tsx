      ...
      <div className="container relative z-10 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            {/* Right column: Visual elements - Updated with modern apartment building */}
            <div className="hidden lg:block relative">
              {/* Modern apartment building render in a "window" frame */}
              <div className="relative bg-white rounded-xl shadow-xl overflow-hidden transition-all hover:shadow-2xl transform hover:-translate-y-2 duration-500">
                ...
                <div className="relative aspect-[4/3] overflow-hidden">
                  <img 
                    src="https://images.unsplash.com/photo-1551029506-0807df4e2031?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80" 
                ...
                {/* Floating stats cards - Positioned to completely overlap the image */}
                <div className="absolute top-24 -right-8 bg-white p-4 rounded-lg shadow-lg transform rotate-6 z-20 animate-float">
                ...
                <div className="absolute bottom-16 -left-6 bg-white p-4 rounded-lg shadow-lg z-20 animate-subtle-bounce">
                  <div className="flex items-center">
              ...
              {/* Testimonial floating element - Fully visible and overlapping the image */}
              <div className="absolute -bottom-4 right-12 bg-white p-4 rounded-lg shadow-lg max-w-xs z-20 animate-fade-in stagger-6">
