...
export const useSubscriptionInfo = () => {
  ...
  const { data: subscriptionInfo, isLoading, error } = useQuery({
    ...
    queryFn: async (): Promise<SubscriptionInfo> => {
      ...
      // IMPORTANT: First check if the empresa has an active subscription
      if (empresaId) {
      ...
      // If no empresa subscription found, check for user-specific subscription
      ...
      const subscriptionData = await processSubscription(subscription, empresaId);
      return subscriptionData;
    },
    enabled: !!userId,
  });
