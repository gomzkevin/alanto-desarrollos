  ...
  const normalizeDesarrollos = (desarrollosData: Desarrollo[]): Desarrollo[] => {
    return desarrollosData.map(desarrollo => {
      const normalizedDesarrollo: Desarrollo = {
        ...
        fecha_inicio: desarrollo.fecha_inicio !== undefined ? desarrollo.fecha_inicio : null,
        fecha_finalizacion_estimada: desarrollo.fecha_finalizacion_estimada !== undefined ? desarrollo.fecha_finalizacion_estimada : null,
        ...
        total_unidades: desarrollo.total_unidades !== undefined ? desarrollo.total_unidades : 0,
        unidades_disponibles: desarrollo.unidades_disponibles !== undefined ? desarrollo.unidades_disponibles : 0,
        avance_porcentaje: desarrollo.avance_porcentaje !== undefined ? desarrollo.avance_porcentaje : 0,
        comision_operador: desarrollo.comision_operador !== undefined ? desarrollo.comision_operador : 0,
        moneda: desarrollo.moneda || 'MXN',
        fecha_entrega: desarrollo.fecha_entrega !== undefined ? desarrollo.fecha_entrega : null,
        adr_base: desarrollo.adr_base !== undefined ? desarrollo.adr_base : 0,
        ocupacion_anual: desarrollo.ocupacion_anual !== undefined ? desarrollo.ocupacion_anual : 0,
        es_impuestos_porcentaje: desarrollo.es_impuestos_porcentaje !== undefined ? desarrollo.es_impuestos_porcentaje : false,
        impuestos: desarrollo.impuestos !== undefined ? desarrollo.impuestos : 0,
        ...
        gastos_variables: desarrollo.gastos_variables !== undefined ? desarrollo.gastos_variables : 0,
        gastos_fijos: desarrollo.gastos_fijos !== undefined ? desarrollo.gastos_fijos : 0,
        ...
        mantenimiento_valor: desarrollo.mantenimiento_valor !== undefined ? desarrollo.mantenimiento_valor : 0,
