...
import { Save, Trash, Plus, Settings, Users, Building2, CreditCard } from 'lucide-react';
          ...
          <TabsContent value="finanzas">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Estos valores se utilizarán como base para todas las proyecciones financieras
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="adrBase">Tarifa diaria promedio (ADR) base</Label>
                      <div className="flex">
                        <Input
                          id="adrBase"
                          type="number"
                          value={finanzasConfig.adrBase}
                          onChange={(e) => setFinanzasConfig({...finanzasConfig, adrBase: parseInt(e.target.value) || 0})}
                        />
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="ocupacionAnual">Ocupación anual promedio</Label>
                      <div className="flex">
                        <Input
                          id="ocupacionAnual"
                          type="number"
                          min="0"
                          max="100"
                          value={finanzasConfig.ocupacionAnual}
                          onChange={(e) => setFinanzasConfig({...finanzasConfig, ocupacionAnual: parseInt(e.target.value) || 0})}
                        />
                        <div className="flex items-center justify-center w-16 h-10 bg-slate-100 border border-l-0 border-slate-200 rounded-r-md">
                      ...
                      <div className="flex">
                        ...
                        <div className="flex items-center justify-center w-16 h-10 bg-slate-100 border border-l-0 border-slate-200 rounded-r-md">
                          <span className="text-sm text-slate-500">
                            {finanzasConfig.esMantenimientoPorcentaje ? '%' : 'MXN'}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="plusvaliaAnual">Plusvalía anual estimada</Label>
                      <div className="flex">
                        <Input
                          id="plusvaliaAnual"
                          type="number"
                          step="0.1"
                          value={finanzasConfig.plusvaliaAnual}
                          onChange={(e) => setFinanzasConfig({...finanzasConfig, plusvaliaAnual: parseFloat(e.target.value) || 0})}
                        />
                        <div className="flex items-center justify-center w-16 h-10 bg-slate-100 border border-l-0 border-slate-200 rounded-r-md">
                          <span className="text-sm text-slate-500">%</span>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="gastosVariables">Gastos variables</Label>
                    <div className="flex">
                      <Input
                        id="gastosVariables"
                        type="number"
                    ...
                    <p className="text-xs text-slate-500">Porcentaje sobre ingresos</p>
                  </div>
